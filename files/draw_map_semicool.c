...
/*   Updated: 2022/11/15 13:20:35 by mmensing         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	init_x(data, move_left_right+  y  *line_len, move_left_right+  y + 1  *line_len);
// 	init_y(data,  move_up_down+  y  *line_len*fdf->y_vector, move_up_down+  y+ 1  *line_len*fdf->x_vector);
// 	put_line(data);
// 	put_cross(data, move_left_right+  y+ 1 *line_len, move_up_down+  y+ 1 *line_len*fdf->x_vector);
	
// 	init_x(data, move_left_right+  y  *line_len, move_left_right+  y + 1  *line_len);
// 	init_y(data,  move_up_down+  y  *line_len*fdf->y_vector, move_up_down+  y+ 1  *line_len*fdf->y_vector);
// 	put_line(data);
// 	put_cross(data, move_left_right+  y+ 1 *line_len, move_up_down+  x+ 1 *line_len*fdf->y_vector);
